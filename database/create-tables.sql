...
-- Sun 23 Mar 2025 05:05:18 PM -03
...
-- -----------------------------------------------------
-- Table `coffee-db`.`tables`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `coffee-db`.`tables` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `table_identifier` VARCHAR(45) NOT NULL,
